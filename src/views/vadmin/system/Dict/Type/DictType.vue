...
<template>
  <ContentWrap>
    ...
    <Table v-model:current-page="currentPage" v-model:page-size="pageSize" showAction activeUID="type"
      :columns="tableColumns" default-expand-all :highlightCurrentRow="true" node-key="id" :data="dataList"
      :loading="loading" :pagination="{
        total
      }" @register="tableRegister" @current-change="handleCurrentChange" @refresh="getList">
      <template #toolbar>
        <ElRow :gutter="10">
          <ElCol :span="1.5">
